...
export default function Sheet07KDTracker({ data, locked, l1, loginCodes, allSheets, onUpdate }) {
  const label = "Sheet07KDTracker".replace("Sheet0","Sheet 0").replace(/([A-Z])/g,' ').trim();
  return (
