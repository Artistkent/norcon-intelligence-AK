...
export default function Sheet03Schedule({ data, locked, l1, loginCodes, allSheets, onUpdate }) {
  const label = "Sheet03Schedule".replace("Sheet0","Sheet 0").replace(/([A-Z])/g,' ').trim();
  return (
