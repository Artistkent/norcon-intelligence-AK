...
export default function Sheet08Stakeholders({ data, locked, l1, loginCodes, allSheets, onUpdate }) {
  const label = "Sheet08Stakeholders".replace("Sheet0","Sheet 0").replace(/([A-Z])/g,' ').trim();
  return (
